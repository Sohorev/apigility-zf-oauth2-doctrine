...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'password', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'blocked', 'firstname', 'lastname', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'token', 'client', 'accessToken', 'authorizationCode', 'refreshToken'];
        }

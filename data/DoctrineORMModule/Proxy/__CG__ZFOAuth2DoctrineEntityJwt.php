 ...
 */
class Jwt extends \ZF\OAuth2\Doctrine\Entity\Jwt implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Jwt' . "\0" . 'subject', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Jwt' . "\0" . 'publicKey', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Jwt' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Jwt' . "\0" . 'client'];
        }

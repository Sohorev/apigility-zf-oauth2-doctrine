 ...
 */
class Scope extends \ZF\OAuth2\Doctrine\Entity\Scope implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'scope', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'isDefault', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'client', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'authorizationCode', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'refreshToken', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\Scope' . "\0" . 'accessToken'];
        }

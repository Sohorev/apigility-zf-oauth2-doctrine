 ...
 */
class AccessToken extends \ZF\OAuth2\Doctrine\Entity\AccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'accessToken', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'expires', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'client', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'scope', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AccessToken' . "\0" . 'user'];
        }

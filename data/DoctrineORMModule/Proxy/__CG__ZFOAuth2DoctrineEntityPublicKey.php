 ...
 */
class PublicKey extends \ZF\OAuth2\Doctrine\Entity\PublicKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\PublicKey' . "\0" . 'publicKey', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\PublicKey' . "\0" . 'privateKey', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\PublicKey' . "\0" . 'encryptionAlgorithm', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\PublicKey' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\PublicKey' . "\0" . 'client'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PublicKey $proxy) {
    ...
    public function setEncryptionAlgorithm($encryptionAlgorithm)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEncryptionAlgorithm', [$encryptionAlgorithm]);

        return parent::setEncryptionAlgorithm($encryptionAlgorithm);
    }
    ...
    public function getEncryptionAlgorithm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEncryptionAlgorithm', []);

        return parent::getEncryptionAlgorithm();
    }

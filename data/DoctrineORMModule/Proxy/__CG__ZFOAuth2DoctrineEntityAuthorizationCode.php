 ...
 */
class AuthorizationCode extends \ZF\OAuth2\Doctrine\Entity\AuthorizationCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'authorizationCode', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'redirectUri', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'expires', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'idToken', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'client', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'scope', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\AuthorizationCode' . "\0" . 'user'];
        }

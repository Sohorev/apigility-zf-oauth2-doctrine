 ...
 */
class RefreshToken extends \ZF\OAuth2\Doctrine\Entity\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'refreshToken', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'expires', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'id', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'client', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'scope', '' . "\0" . 'ZF\\OAuth2\\Doctrine\\Entity\\RefreshToken' . "\0" . 'user'];
        }
